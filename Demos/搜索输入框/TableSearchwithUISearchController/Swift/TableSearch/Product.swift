...
class Product: NSObject, NSCoding {
    ...
    required init?(coder aDecoder: NSCoder) {
		...
		guard let decodedHardwareType = aDecoder.decodeObject(forKey: CoderKeys.nameKey.rawValue) as? String else {
			fatalError("A hardwareType did not exist. In your app, handle this gracefully.")
		}
		hardwareType = decodedHardwareType
