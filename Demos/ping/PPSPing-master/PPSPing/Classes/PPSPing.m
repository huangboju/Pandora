...
@property (strong, nonatomic) NSMutableArray            *hostAddressStrings;
...
-(void)setupWithBlock:(StartupCallback)callback {
    ...
    self.hostAddressStrings = [NSMutableArray array];
...
//                    self.hostAddressString = [[NSString alloc] initWithUTF8String:str];
                    [self.hostAddressStrings addObject:[[NSString alloc] initWithUTF8String:str]];
                }
            }
        }
        
        self.hostAddressString = self.hostAddressStrings.lastObject;
