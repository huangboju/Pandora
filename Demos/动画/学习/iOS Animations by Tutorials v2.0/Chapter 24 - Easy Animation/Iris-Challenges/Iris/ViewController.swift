...
//    dot.addAnimation(move, forKey: nil)
    ...
    //challenges
    self.speakButton.layer.borderWidth = 1.0
    ...
    UIView.animateAndChainWithDuration(1.0, delay: 0.0, options: [], animations: {
      ...
      .animateWithDuration(1.0, delay: 0.0, options: [], animations: {
        self.speakButton.layer.borderColor = UIColor.greenColor().CGColor
        }, completion: nil)
      .animateWithDuration(1.0, delay: 0.0, options: .Repeat, animations: {
        self.speakButton.layer.borderColor = UIColor.orangeColor().CGColor
        }, completion: nil)
  }
