...
class ViewController: UIViewController, UIWebViewDelegate {
    ...
    func webViewDidFinishLoad(_ webView: UIWebView) {
        ...
        jsContext.setObject(model, forKeyedSubscript: "WebViewJavascriptBridge" as NSCopying & NSObjectProtocol)
        
        // 注册到本地的Html页面中
        let url = Bundle.main.url(forResource: "demo", withExtension: "html")
        jsContext.evaluateScript(try? String(contentsOf: url!, encoding: .utf8))
