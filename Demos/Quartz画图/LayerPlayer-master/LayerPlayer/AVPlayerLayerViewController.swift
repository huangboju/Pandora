...
class AVPlayerLayerViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(playerDidReachEndNotificationHandler(_:)), name: "AVPlayerItemDidPlayToEndTimeNotification", object: player.currentItem)
  }
