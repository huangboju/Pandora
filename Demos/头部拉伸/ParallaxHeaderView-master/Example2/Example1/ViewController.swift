...
class ViewController: UITableViewController, ParallaxHeaderViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let heardView = ParallaxHeaderView(style: .thumb,subView: imageView, headerViewSize: CGSize(width: self.tableView.frame.width, height: 64), maxOffsetY: 93, delegate: self)
